...
@implementation FLAdvertiseView
- (NSTimer *)countTimer
{
    if (!_countTimer) {
...
- (void)pushToAd{
    ...
    // 点击的时候push，一般用不上
    [[NSNotificationCenter defaultCenter] postNotificationName:FLAdvertiseDidPushNotification object:nil userInfo:nil];
}
